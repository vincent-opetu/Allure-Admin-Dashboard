  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      >
        ...
        <BsBell className="w-4 h-4 fill-current text-slate-500"/>
        <div className="absolute top-0 right-0 w-2.5 h-2.5 bg-rose-500 border-2 border-white rounded-full"></div>
      </button>

      <Transition
        className="origin-top-right z-10 absolute top-full right-0 -mr-48 sm:mr-0 min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg mt-1"
        show={dropdownOpen}
